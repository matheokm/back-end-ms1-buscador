package com.unir.grupo15.peliculas.controler;
...
import com.unir.grupo15.peliculas.service.PeliculasService;
...
@Slf4j
@Tag(name = "Peliculas Controller", description = "Microservicio encargado de exponer operaciones CRUD sobre peliuclas alojados en una base de datos en memoria.")
...
public class PeliculasController {
    ...
    @ApiResponse(
            responseCode = "200",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = Peliculas.class)))
    public ResponseEntity<List<Peliculas>> getProducts(
        ...
        List<Peliculas> products = service.getProducts(name, country, description, visible);
    ...
    public ResponseEntity<Peliculas> getProduct(@PathVariable String productId) {

        log.info("Request received for product {}", productId);
        Peliculas product = service.getProduct(productId);
    ...
    @Operation(
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    required = true,
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = CreatePeliculasRequest.class))))
    @ApiResponse(
            responseCode = "201",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = Peliculas.class)))
    @ApiResponse(
    ...
    @ApiResponse(
            ...
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = Void.class)),
            description = "No se ha encontrado el producto con el identificador indicado.")
    public ResponseEntity<Peliculas> addProduct(@RequestBody CreatePeliculasRequest request) {

        Peliculas createdProduct = service.createProduct(request);
    ...
    public ResponseEntity<Peliculas> patchProduct(@PathVariable String productId, @RequestBody String patchBody) {

        Peliculas patched = service.updateProduct(productId, patchBody);
        if (patched != null) {
    ...
    @Operation(
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    required = true,
                    content = @Content(mediaType = "application/merge-patch+json", schema = @Schema(implementation = PeliculasDto.class))))
    @ApiResponse(
            responseCode = "200",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = Peliculas.class)))
    @ApiResponse(
    ...
    public ResponseEntity<Peliculas> updateProduct(@PathVariable String productId, @RequestBody PeliculasDto body) {

        Peliculas updated = service.updateProduct(productId, body);
        if (updated != null) {
